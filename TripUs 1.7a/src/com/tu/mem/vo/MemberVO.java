...
public class MemberVO {
	...
	public MemberVO(String mno, String mid, String mpw, String mname, String mnick, String mgender, String mhp,
			String memail, String mbirth, String mdeleteyn, String minsertdate, String mupdatedate, String mdeletedate,
			String mprofile, String mgrade, String snsid, String snsage, String snsbirth, String snsconnectdate,
			String mrecordinsertdate, String mrecordupdatedate) {
		super();
		this.mno = mno;
		this.mid = mid;
		this.mpw = mpw;
	...
	public String toString() {
		return "MemberVO [mno=" + mno + ", mid=" + mid + ", mpw=" + mpw + ", mname=" + mname + ", mnick=" + mnick
				+ ", mgender=" + mgender + ", mhp=" + mhp + ", memail=" + memail + ", mbirth=" + mbirth + ", mdeleteyn="
				+ mdeleteyn + ", minsertdate=" + minsertdate + ", mupdatedate=" + mupdatedate + ", mdeletedate="
				+ mdeletedate + ", mprofile=" + mprofile + ", mgrade=" + mgrade + ", snsid=" + snsid + ", snsage="
				+ snsage + ", snsbirth=" + snsbirth + ", snsconnectdate=" + snsconnectdate + ", mrecordinsertdate="
				+ mrecordinsertdate + ", mrecordupdatedate=" + mrecordupdatedate + "]";
	}
