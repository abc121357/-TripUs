    ...
    <div class="row align-items-center my-5">
      ...
      <div class="col-lg-5">
		...
		<c:forEach items="${mInfo}" var="mem" varStatus="i">
            ...
            <h3 class="member text-primary">닉네임 : </h3><p class="data" align="center">${mem.mnick}</p>
			<h3 class="member text-primary">전화번호 : </h3><p class="data"align="center">${mem.mhp}</p>
            <h3 class="member text-primary">가입일 : </h3><p class="data" align="center">${mem.minsertdate}</p>
