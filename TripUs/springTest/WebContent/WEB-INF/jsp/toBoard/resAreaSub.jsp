...
<script type="text/javascript">
		...
		$(document).ready(function(){
				...
				$.ajax({
						...
						success : function(data) {
							...
							for (var i = 0; i<myItem.length; i++) {
								...
								//if(){
									output += '<img id="offstar" align="right" onclick="onstar('+myItem[i].contentid+', &#39;'+myItem[i].title+'&#39;, &#39;'+myItem[i].addr1+'&#39;)" width="50px" height="50px" src="/img/흰별.jpg" alt="이미지가 없습니다.">';
								//}
								//else{
			...
			function detail(contentid) {
				//alert(contentid);
	  			location.href = "../toBoard/goBoard.do?contentid="+contentid;
			}
				...
				<div class="panel-group" id="accordion">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/toBoard/resAreaSub.do?areaCode=6"> 부산</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/toBoard/resAreaSub.do?areaCode=4"> 대구</a>
							</h4>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/toBoard/resAreaSub.do?areaCode=3">대전</a>
							</h4>
						</div>
					</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a 
									href="/toBoard/resAreaSub.do?areaCode=5">광주</a>
							</h4>
						</div>
					</div>
